...
fun functionTesting(){
    ...
    println("rename:")
    person1.changeName("User")
    person2.changeName("Admin")
    ...
    val personsChild1 = person1 makeChild person2
    val personsChild2 = person2 makeChild person1
    val personsChild3 = personsChild1 makeChild personsChild2
...
internal infix fun Person.makeChild(people2: Person): Person{
    ...
    return Person(id, name, name.hashCode().absoluteValue.toString())
}